    ...
    methods
        function L = LinearLayer(input_size, output_size, ...
            ...
            elseif ~isequal(size(w_init),[input_size, output_size])
                error(strcat('Incorrect dimension on weight tensor initialization ', ...
                             'for linear layer. Was shape: ', mat2str(size(w_init)), ' Needed: ', ...
            ...
            elseif ~isequal(size(b_init),[1, output_size])
                error(strcat('Incorrect dimension on bias tensor initialization ', ...
                             'for linear layer. Was shape: ', mat2str(size(b_init)), ' Needed: ', ...
